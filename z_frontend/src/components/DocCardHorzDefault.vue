<template>
    <div class="medcard">
        ...
        <div class="medcard__content">
            ...
            <hr>
            <p class="m-0 mb-1"> <strong> {{card.position}} </strong> </p>
            <p class="m-0"> Время рабоы: <strong> {{card.time_start | toTime}} - {{card.time_end | toTime}} </strong> </p>
